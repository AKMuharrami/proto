...
export default function Team() {
    ...
    return(
    <div style={{background: '#0B0E13', width: "100vw", paddingBottom:'50px', zIndex:-1}}>
        <div style={{background: '#0B0E13', width: "100vw", paddingBottom:'50px', zIndex:-1, height:'8vh'}}></div>
            ...
            {isTabletOrMobile &&<div style={{display:'flex', justifyContent:'space-between', background:'#323136', height:'25vh'}}>
            <img src="https://generations.krea.ai/images/cc9b4362-54cb-4366-ace2-ae639afb7d39.webp" alt=""></img>
            </div>}
