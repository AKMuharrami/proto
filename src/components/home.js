    ...
    const cardVariants = {
      ...
      function handlemsclick () {
       ...
       function handlemgclick () {
        ...
        ref.current.scrollLeft= 870
      }
      function handlemeclick () {
        ref.current.scrollLeft= 1320 
      }
      function handlemaclick () {
        ref.current.scrollLeft= 1770 
      }
      function handlemskclick () {
        ref.current.scrollLeft= 2220 
      }
      function handlemguclick () {
        ref.current.scrollLeft= 2670
      }
      function handlemmiclick () {
        ref.current.scrollLeft= 3210 
      }
            ...
            {isTabletOrMobile &&<div>
                ...
                style={{ textAlign:'center'}}>
                    ...
                    <button onClick={() => {
                      ...
                      .then (() => {n()})
                     }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', height:'6vh',width:'21vw',textAlign:'center',lineHeight:1}}><br></br>Goal/destination</h3></button>
                    <button onClick={() => {
                      const bbb = new Promise ((resolve, reject) => {
                      setTimeout(() => {
                        resolve(n());
